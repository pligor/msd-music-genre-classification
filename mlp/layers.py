...
class MaxPoolingLayer_pligor(Layer):
...
class DropoutLayer_pligor(StochasticLayer):
    ...
    def fprop(self, inputs, stochastic=True):
        ...
        self.binaryMask = self.random_binary_mask(self.incl_prob, inputs.shape, self.rng) if\
